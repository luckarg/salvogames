...
public class SalvoController {
    ...
    */
    ...
    public Map<String, Object> getGamesInfo(Authentication authentication) {
        ...
        gameDTO.put("games", gameRepository.findAll().stream().map(Game::getGameDTO).collect(toList()));
    ...
    private Map<String, Object> gameViewDTO(GamePlayer gamePlayer) {
        ...
        if (gamePlayer != null) {
            ...
            dto.put("gamePlayer", gamePlayer.getGame().getGamePlayers().stream().map(GamePlayer::getGamePlayerDTO));
    ...
    public List<Object> getPlayerInfo() {
        return playerRepository.findAll().stream().map(Player::getPlayerDTO).collect(toList());
    }
